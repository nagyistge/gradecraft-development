...
ReactOnRails.configure do |config|
  ...
  # GRADECRAFT CI NOTE: `yarn &&` is added here for Codeship. We should add `yarn install`
  # to build commands within codeship, to avoid running locally, and remove.
  config.npm_build_test_command = "yarn && yarn run build:test"
